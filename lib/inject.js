...
exports.sync = function(signatureFn, fn) {
  return function() {
    ...
    injected = typeof signatureFn === 'function' ? signatureFn(argsOf(fn)) : signatureFn instanceof Array ? signatureFn : signatureFn instanceof Object ? (config = signatureFn, []) : [signatureFn];
